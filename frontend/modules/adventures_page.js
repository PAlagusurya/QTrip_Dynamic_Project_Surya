...
function filterByCategory(list, categoryList) {
  ...
  //   let current_category = categoryList[i];
  //   //console.log(i)
  //   list.filter(adventures =>{
  //     if(current_category === adventures.category){
  //       filteredCategory.push(adventures);
  //     }
      
  //   }) 
    //console.log("current:",current_category);
...
function filterFunction(list, filters) {
  ...
  let selectedDuration = filters["duration"].split("-")
  let low = selectedDuration[0];
  let high =  selectedDuration[1];
...
function getFiltersFromLocalStorage() {
  ...
  //JSON-->Converting string to objects
